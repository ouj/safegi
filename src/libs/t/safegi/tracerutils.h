...
inline bool isvalid(const shadowSample<world_s>& s) { return !iszero(s.le) && !iszero(s.pdf); }
inline bool isvalid(const brdfSample<world_s>& s) { return !iszero(s.f) && !iszero(s.pdf); }
