...
void save(const image<spectrum<radiance_d>>& img, const string& filename, const mreal<invradiance_d>& s)
{
...
void save(const image<spectrum<radiance_d>>& img, const string& filename) {
